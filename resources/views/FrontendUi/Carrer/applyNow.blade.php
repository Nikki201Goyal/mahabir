...
<!-- <section id="form">
            <div class="container" style="margin-top: 9%;">
                ...
                <div class="row">
                    <div class="col-md-6" style="margin-top:-20%; margin-left: 30%;">
                        <h3>Register for Vacancy</h3>
                        <form class="bill-form" action="{{route('storeJobApplied')}}">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12" >
                                    <div class="form-group" >
                                        <label>vacancy<span class="text-primary">*</span></label>
                                        <select rel="calc_shipping_state" name="vacancy" class="country_to_state form-control" id="calc_shipping_country" name="calc_shipping_country">
                                            <option value="">Select a position</option>
                                            <option class="opt1" value="AX">Reception</option><option value="AF">Accountant</option><option value="AF">Mechanics</option><option value="AF">Labour</option>            
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12" >
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="town" id="city" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                ...
                <form class="bill-form" action="{{route('storeJobApplied')}}">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>vacancy<span class="text-primary">*</span></label>
                                <select rel="calc_shipping_state" class="country_to_state form-control" id="calc_shipping_country" name="Vacancy">
                                    <option value="">Select a position</option>
                                    <option class="opt1" value="AX">Reception</option>
                                    <option value="AF">Accountant</option>
                                    <option value="AF">Mechanics</option>
                                    <option value="AF">Labour</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Country <span class="text-primary">*</span></label>
                                <select rel="calc_shipping_state" class="country_to_state form-control" id="calc_shipping_country" name="country">
                                    <option value="">Select a country…</option>
                                    <option class="opt1" value="AX">Nepal</option>
